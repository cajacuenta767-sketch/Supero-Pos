...
export const ExpensesView: React.FC = () => {
 ...
 const categoryBadge = {
                    'Servicios Básicos': 'bg-accent-soft text-accent-ink dark:bg-accent-soft border-accent/30',
                    'Alquileres': 'bg-accent-soft text-accent-ink dark:bg-accent-soft border-accent/30',
 ...
 return (
                    <tr key={exp.id} className="hover:bg-sunken">
                      <td className="p-4 font-mono font-extrabold text-accent">
                        {exp.id}
                        <span className="block text-micro text-ink-3 font-normal">Ref: {exp.ref_number}</span>
                      </td>
 ...
 className="p-1.5 text-accent hover:bg-accent-soft rounded-md" title="Ver Comprobante Adjunto"
                        >
                          <Eye className="w-4 h-4" />
                        </button>
                        <button className="p-1.5 text-ok hover:bg-ok-soft rounded-md" title="Imprimir Recibo">
          ...
          <div className="flex items-center justify-between border-b border-line pb-4">
            <div>
              <h3 className="font-extrabold text-base text-ink flex items-center gap-2">
                <RefreshCw className="w-5 h-5 text-ok" /> Control y Reposición de Fondo Fijo de Caja Chica
              </h3>
              <p className="text-body text-ink-3">Administración de recargas y rendimiento de vales auxiliares</p>
            </div>
            <button
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-raised rounded-md border border-line shadow-e3 w-full max-w-lg overflow-hidden space-y-4">
            <div className="p-5 border-b border-line flex items-center justify-between">
              ...
              <button onClick={() => setIsExpenseModalOpen(false)} className="text-ink-3 hover:text-ink-2">✕</button>
            </div>
 ...
 className="w-full mt-1 p-2 bg-sunken border border-line rounded-md font-mono text-center font-bold text-base"
              ...
              <div className="flex justify-end gap-2 pt-2">
                <button type="button" onClick={() => setIsExpenseModalOpen(false)} className="px-4 py-2 bg-sunken text-ink rounded-md font-bold">Cancelar</button>
