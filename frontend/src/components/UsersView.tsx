...
export const UsersView: React.FC = () => {
 ...
 u.is_active ? 'bg-accent text-white' : 'bg-gray-400 text-white'
                        ...
                        <td className="p-4">
                          <span className={`px-2.5 py-1 rounded-md text-micro font-bold border ${badgeClass}`}>
                            {u.role}
                          </span>
                        </td>
 ...
 u.is_active ? 'translate-x-6' : 'translate-x-1'
                        ...
                        <td className="p-4 font-mono text-ink-2 text-micro">
                          {u.last_login}
                        </td>
              ...
              <div className="p-4 bg-sunken rounded-md border border-line space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-body">
                  {[
                    ...
                    <label key={p.key} className="flex items-center justify-between p-2 bg-raised rounded-md border border-line cursor-pointer">
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-raised rounded-md border border-line shadow-e3 w-full max-w-md overflow-hidden space-y-4 p-5">
            ...
            <p className="text-body text-ink-2">
              Asigne una nueva contraseña para el operador <span className="font-bold text-ink">@{resetTargetUser.username}</span> ({resetTargetUser.name}).
            </p>
