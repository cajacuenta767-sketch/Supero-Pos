...
import { Bell, Printer, MessageSquare, Mail, Eye, RotateCcw, Save, Settings2 } from 'lucide-react';
...
export const NotificationsView: React.FC = () => {
  const [activeSubTab, setActiveSubTab] = useState<
    'thermal-editor' | 'digital-channels' | 'branch-rules'
  >('thermal-editor');
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-raised p-5 rounded-md border border-line shadow-e1">
        <div>
          ...
          <p className="text-body text-ink-2 mt-1">
            Diseñador de tickets térmicos (58mm/80mm), comprobantes en PDF, envío por WhatsApp y
            correo electrónico
          </p>
        </div>
            ...
            <div className="space-y-4 text-body">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        paper_width: e.target.value as typeof config.paper_width,
                      })
                    }
              ...
              <div>
                <label className="font-bold text-ink-2">
                  Razon Social / Nombre Empresa (&#123;&#123;company_name&#125;&#125;)
                </label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="font-bold text-ink-2">
                    Dirección Comercial (&#123;&#123;company_address&#125;&#125;)
                  </label>
                  <input
                    type="text"
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-sunken text-white p-4 rounded-md flex items-center justify-between shadow-e1">
              <span className="font-extrabold text-body flex items-center gap-2">
                <Eye className="w-4 h-4 text-ok" /> Previsualización Térmica en Tiempo Real (
                {config.paper_width})
              </span>
            ...
            <div
              className={`mx-auto bg-white text-black p-6 rounded-md shadow-e3 font-mono text-micro leading-tight select-none border border-line-strong transition-all ${
              ...
              <div className="py-2 border-b border-dashed border-black space-y-1.5">
                ...
                <div>
                  ...
                  {config.show_imei_serials && (
                    <span className="text-micro text-ink-2 font-bold block">
                      IMEI: 358492019482712
                    </span>
                  )}
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-raised p-6 rounded-md border border-line shadow-e1 space-y-4">
            ...
            <div className="space-y-3 text-body">
              <div>
                <label className="font-bold text-ink-2">
                  Plantilla de Mensaje de Texto (WhatsApp)
                </label>
                <textarea
                  rows={4}
          ...
          <div className="bg-raised p-6 rounded-md border border-line shadow-e1 space-y-4">
            ...
            <div className="space-y-3 text-body">
              <p className="text-ink-3">
                Envío automático de comprobantes fiscales en formato PDF adjunto al correo
                electrónico registrado del cliente al finalizar el pago en el POS.
              </p>
              ...
              <div className="p-3 bg-accent-soft border border-accent/30 rounded-md text-accent-ink">
                ...
                <span className="text-micro">
                  Motor listo para despacho de correos en tiempo real.
                </span>
              </div>
            </div>
          </div>
